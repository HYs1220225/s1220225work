...
int main(){
  ...
  float offset = -0.15; // -0.15 -> -0.30
  float cellsize = 0.025;
  
  float halfwidth = (2 * fabs(offset) / cellsize) + 1;
  ...
  // openvdb::FloatGrid::Ptr grid = openvdb::FloatGrid::create(backbroundValue);
  openvdb::FloatGrid::Ptr grid = openvdb::tools::createLevelSetSphere<openvdb::FloatGrid>(1,openvdb::Vec3f(0,0,0),cellsize,halfwidth);
